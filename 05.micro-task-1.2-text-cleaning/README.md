Understood — here are the **actual task instructions** (the README-style instructions) for:

```
05.micro-task-1.2-text-cleaning
```

This is the file that belongs in the **root of the micro-task folder**, alongside the code — *not* the learning.md.

Clear, simple, actionable.
Exactly like the instructions you used for 01, 02, 03, 04.
